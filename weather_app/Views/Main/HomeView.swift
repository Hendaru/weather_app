...
//  weather_app
//
//  Created by Hendaru on 11/12/23.
//
                ...
                ZStack{
                    ...
                    VStack(spacing:-10 * (1-bottomSheetTranslationProrated)){
                        ...
                        VStack{
                            ...
                            Text("H:24°   L:18°").font(.title3.weight(.semibold)).opacity(1-bottomSheetTranslationProrated)
                        }
                        
                        Spacer()
                    }.padding(.top,51).offset(y: -bottomSheetTranslationProrated * 46)
